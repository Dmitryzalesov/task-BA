...
### 6.2. Данные для формирования уведомления
...
### 7.1. Некорректное входящее сообщение
...
### 7.3. Недопустимый статус процедуры
...
### 7.4. Ошибка обработки отдельной заявки
